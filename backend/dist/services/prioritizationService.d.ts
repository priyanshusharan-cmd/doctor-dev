import type { TestGap, ConfigIssue, PriorityFinding, HealthScore, TestProfile } from '../types';
/**
 ...
 */
export declare function calculateHealthScore(totalSourceFiles: number, testGaps: TestGap[], configIssues: ConfigIssue[], testProfile: TestProfile): HealthScore;
